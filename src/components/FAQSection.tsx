...
const faqData = [
  ...
  },
  {
    ...
    answer: "Стандартная сборка занимает от 2-3 дней. Срочная сборка возможна от 1 дня при наличии всех комплектующих на складе. После сборки мы проводим тестирование системы в течение 24 часов."
  },
  {
  ...
  },
  {
    ...
    answer: "Мы доставляем по всей России. Доставка по Грозному — от 1-2 дней, по России — от 3-7 дней в зависимости от региона. Сборка занимает от 2-3 дней, срочная сборка — от 1 дня. Компьютер упаковывается в специальную защитную упаковку для безопасной транспортировки."
  },
  {
