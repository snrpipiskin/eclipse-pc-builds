...
const faqData = [
  ...
  },
  {
    ...
    answer: "Мы доставляем по всей России. Доставка по Москве — 1-2 дня, по России — 3-7 дней в зависимости от региона. Компьютер упаковывается в специальную защитную упаковку для безопасной транспортировки."
  },
  {
