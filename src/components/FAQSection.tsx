...
const faqData = [
  ...
  },
  {
    ...
    answer: "Сборка компьютера занимает от 2-3 дней. После сборки мы проводим тестирование системы для проверки стабильности работы всех компонентов."
  },
  {
  ...
  },
  {
    ...
    answer: "Мы доставляем по всей России. Доставка по Грозному — от 1-2 дней, по России — от 7 дней в зависимости от региона. Компьютер упаковывается в специальную защитную упаковку для безопасной транспортировки."
  },
  {
